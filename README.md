...
## Session Examples
A request example is in EC530_Project_4/Code/API_test.py. The example use the sample speech file in EC530_Project_4/Code/This_is_a_test.wav. A sample google cloud sever is set.
